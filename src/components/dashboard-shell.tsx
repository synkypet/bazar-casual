...
import {
  createCashEntry, createCustomer, createSale, recordPayment, updateProfile,
  type ActionResult,
} from "@/app/actions";
import { logout } from "@/app/login/actions";

type View = "home" | "customers" | "collections" | "movements" | "settings";
type Modal = "menu" | "customer" | "sale" | "cash" | "payment" | "more" | null;
type Customer = { id: string; name: string; phone: string | null; notes: string | null; isActive: boolean; createdAt: string };
type Collection = {
